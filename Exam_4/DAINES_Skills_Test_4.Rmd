---
title: "DAINES_Skills_Test_4"
author: "Austin Daines"
date: "5/4/2021"
output: html_document
---
This is a retake of Exam 3
...
### I. First we will load the data FacultySalaries_1995.csv   
...
Looks a little messy. In order to replicate Fig1.png we will need to clean the data. 
```{r, echo=FALSE, warning=FALSE}
...
### II. Our next task is to Export an ANOVA table to a file called "Salary_ANOVA_Summary.txt"
...
Well, it's time to tidy it up so we can reproduce Fig2. 
